...
public class TestModel {
    ...
    public void testD(){
        ...
        Assert.assertEquals(model.getId(), ((Purchase)dataProvider.getRecordById(purchaseTestFirst)
                .getBean()).getModelId());
        Assert.assertEquals(model.getId(), ((Purchase)dataProvider.getRecordById(purchaseTestSecond)
                .getBean()).getModelId());
