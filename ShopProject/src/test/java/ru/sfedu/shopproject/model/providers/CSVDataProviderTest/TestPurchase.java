...
public class TestPurchase {
    ...
    private static Logger logger = Logger.getLogger(TestPurchase.class);
    private static DataProviderCSV dataProvider;
    private static Purchase purchase;
    private static User user;
    private static Model model;
    
    //    check purchases test
    @Test
    public void testa(){
        ...
        dataProvider.clearPurchases();
        Assert.assertEquals(StatusType.SUCCESS, dataProvider.saveRecord(purchase).getStatus());
        Assert.assertEquals(StatusType.SUCCESS, dataProvider.buyModel(purchase).getStatus());
        Assert.assertEquals(StatusType.SUCCESS, dataProvider.deleteRecord(purchase).getStatus());
    ...
    public void testB() {
        ...
        DataProviderResult trueResult = dataProvider.getEntityByTitle(purchase.getTitle()
                , TypeOfEntities.PURCHASE);
        DataProviderResult fakeResult = dataProvider.getEntityByTitle(fakePurchase.getTitle()
                , TypeOfEntities.PURCHASE);
    ...
    public void testE(){
        ...
        Assert.assertEquals(0, ((Purchase)dataProvider.getRecordById(testPurchase).getBean()).getStatus());
        ...
        Assert.assertEquals(dataProvider.deleteRecord(testPurchase).getStatus(), StatusType.SUCCESS);
    }
